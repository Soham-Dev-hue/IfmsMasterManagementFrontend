...
export class CommonService {
  ...
  getAllFinancialYears(): Observable<any[]> {
    return this.http.get<any[]>(
      `${this.apiUrl}FinancialYearMST/getFinancialYear`
    );
  }
  ...
  updateDepartment(id: number, department: any): Observable<any> {
    return this.http.put(
      `${this.apiUrl}DepartmentsMaster/update/${id}`,
      department
    );
  }
  ...
  getSubMajorHeadByMajorHeadId(id: any): Observable<any> {
    return this.http.get<any>(
      `${this.apiUrl}SubMajorHeadsMaster/SubMajorHeadByMajorHeadId/${id}`
    );
  }
  getMinorHeadBySubMajorId(id: any): Observable<any> {
    return this.http.get<any>(
      `${this.apiUrl}MinorHeadMaster/MinorHeadBySubMajorHeadId/${id}`
    );
  }
  getSchemeHeadByMinorHeadId(id: any): Observable<any> {
    return this.http.get<any>(
      `${this.apiUrl}SchemeHeadsMaster/SchemeHeadByMinorHeadId/${id}`
    );
  }
  getMajorHeadByDemandCode(demandCode: any): Observable<any> {
    return this.http.get<any>(
      `${this.apiUrl}MajorHeadsMaster/GetMajorByDemand/${demandCode}`
    );
  }
  getAllMinorHeads(
    search: string = '',
  ...
  getSubDetailHeadByDetailHeadId(id: any): Observable<any> {
    return this.http.get<any>(
      `${this.apiUrl}SubDetailHeadsMaster/SubdetailHeadByDetailHeadId/${id}`
    );
  }
  getAllSchemeTypes(
    search: string,
  ...
  getAllAdmissibleReappropriations(): Observable<any[]> {
    return this.http.get<any[]>(
      `${this.apiUrl}AdmissibleReappropriationMaster`
    );
  }
